...
parser.add_argument("-i", "--sample_id", type=str, default="sample", help="id of the sample processed")
parser.add_argument("-e", "--preprocess_result", type=str, default="intermediate/", help="directory that stores the preprocess results")
parser.add_argument("-b", "--If_subsampling", type=str, default="No", help="whether doing subsampling or not")
...
parser.add_argument("-n", "--No_subsampling", type=int, help="directory that stores the preliminary results")
parser.add_argument("-m", "--Rep_num", type=int, help="directory that stores the preliminary results")
...
parser.add_argument("-o", "--overlap_size", type=float, default=0, help="controls how large two consecutive windows overlaps")
...
#preprocess_result = sys.argv[5]
#preliminary_result = sys.argv[6]
#If_subsampling = sys.argv[7]
...
if args_1.If_subsampling == "No":
	if args_1.Lambda == None:
		#final_result = sys.argv[8]
		#filtering_flag = sys.argv[9]
...
elif args_1.If_subsampling == "Yes":
	subsampling_clip = current_dir + "/src/run_kernel_sub.py"
	#_No_subsampling = sys.argv[8]
	#_Rep_num = sys.argv[9]
	#_window_size = sys.argv[10]
	#_overlap_size = sys.argv[11]
	if args_1.Lambda == None:
		#final_result = sys.argv[12]
		#filtering_flag = sys.argv[13]
